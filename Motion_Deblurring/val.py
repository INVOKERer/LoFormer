...
from basicsr.models.archs.LoFormer_arch import LoFormer as Net
...
parser.add_argument('--input_dir', default='/data/GoPro/test/blur', type=str, help='Directory of validation images') # blur sharp_phase
parser.add_argument('--tar_dir', default='/data/GoPro/test/sharp', type=str, help='Directory of gt images') # sharp sharp_phase
parser.add_argument('--result_dir', default='./results/GoPro', type=str, help='Directory for results')

parser.add_argument('--weights',
                    default='./ckpts/Loformer-L/net_g_GoPro.pth',
...
yaml_file = 'test_LoformerLarge.yml'
import yaml
